...
public class Hw05Tests {
  ...
  public void testAnimationConstructor() {
    Animation anim =
            new BasicAnimation(1, new Point(200, 200),
                    new Dimension(50, 100), Color.RED, 10,
                    new Point(100, 100), new Dimension(100, 50), Color.WHITE);
  ...
  public void testAnimationModel() {
    ...
    Animation animR1 =
            new BasicAnimation(1, new Point(200, 200),
                    new Dimension(50, 100), Color.RED, 10,
                    new Point(200, 200), new Dimension(50, 100), Color.RED);
    Animation animR2 =
            new BasicAnimation(10, new Point(200, 200),
                    new Dimension(50, 100), Color.RED, 50,
                    new Point(300, 300), new Dimension(50, 100), Color.RED);

    Animation animC1 =
            new BasicAnimation(6, new Point(440, 70),
                    new Dimension(120, 60), Color.BLUE,20,
                    new Point(440, 70), new Dimension(120, 60), Color.GREEN);
    Animation animC2 =
            new BasicAnimation(20, new Point(440, 70),
                    new Dimension(120, 60), Color.GREEN, 50,
                    new Point(440, 250), new Dimension(60, 0), Color.BLACK);
  ...
  public void testFailedAddAnimation3() {
    ...
    Shape shape = new ShapeImpl("R", ShapeType.RECTANGLE);
    Animation a1 = new BasicAnimation(1, new Point(50, 50),
            new Dimension(10, 10), Color.black, 10,
            new Point(50, 50), new Dimension(50, 50), Color.black);
    shape.addAnimation(a1);

    Animation badPoint = new BasicAnimation(10, new Point(40, 50),
            new Dimension(10, 10), Color.black, 15,
            new Point(40, 50), new Dimension(10, 10), Color.black);
    try {
    ...
    Animation badSize = new BasicAnimation(10, new Point(50, 50),
            new Dimension(40, 50), Color.black, 15,
            new Point(50, 50), new Dimension(50, 50), Color.black);
    try {
    ...
    Animation badColor = new BasicAnimation(10, new Point(50, 50),
            new Dimension(50, 50), Color.WHITE, 15,
            new Point(50, 50), new Dimension(50, 50), Color.black);
    try {
