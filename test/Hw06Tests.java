...
public class Hw06Tests {
  ...
  @Before
  public void init() {
    this.model = new AnimationModelImpl(new Point(200, 200),
  ...
  public void testSVGView() {
    ...
    assertEquals("<svg width=\"600\" height=\"600\" version=\"1.1\" xmlns=\"http:" +
            "//www.w3.org/2000/svg\">\n"
            ...
            + "<animate attributeType=\"xml\" begin=\"10000ms\" dur=\"40000ms\" " +
            "attributeName=\"y\" from=\"200\" to=\"300\"/>\n"
            + "</rect>\n"
            + "<ellipse id=\"C\" cx=\"440\" cy=\"70\" rx=\"120\" ry=\"60\" " +
            "fill=\"rgb(0,255,0)\">\n"
            + "<animate attributeType=\"xml\" begin=\"6000ms\" dur=\"14000ms\" " +
            "attributeName=\"fill\" from=\"rgb(0,0,255)\" to=\"rgb(0,255,0)\"/>\n"
            + "<animate attributeType=\"xml\" begin=\"20000ms\" dur=\"30000ms\" " +
            "attributeName=\"cy\" from=\"70\" to=\"250\"/>\n"
            + "<animate attributeType=\"xml\" begin=\"20000ms\" dur=\"30000ms\" " +
            "attributeName=\"rx\" from=\"120\" to=\"60\"/>\n"
            + "<animate attributeType=\"xml\" begin=\"20000ms\" dur=\"30000ms\" " +
            "attributeName=\"ry\" from=\"60\" to=\"0\"/>\n"
            + "<animate attributeType=\"xml\" begin=\"20000ms\" dur=\"30000ms\" " +
            "attributeName=\"fill\" from=\"rgb(0,255,0)\" to=\"rgb(0,0,0)\"/>\n"
            + "</ellipse>\n"
            + "</svg>", ap.toString());
  }
